...
namespace NUnitTestProject1
{
    public class Utils_GetContextMenuType_Test
    {
        ...
        public void GetContextMenuType_SingleCell_1()
        {
            ...
            var info = ContextMenu.Make(address) as SingleCellMenuInfo;
        ...
        public void GetContextMenuType_Cells_1()
        {
            ...
            var info = ContextMenu.Make(address) as CellsMenuInfo;
        ...
        public void GetContextMenuType_Columns_1()
        {
            ...
            var info = ContextMenu.Make(address) as ColumnMenuInfo;
        ...
        public void GetContextMenuType_Rows_1()
        {
            ...
            var info = ContextMenu.Make(address) as RowMenuInfo;
        ...
        public void GetContextMenuType_Unknown_1()
        {
            ...
            var info = ContextMenu.Make(address) as UnknownMenuInfo;
        ...
        public void GetContextMenuType_Unknown_2()
        {
            ...
            var info = ContextMenu.Make(address);
